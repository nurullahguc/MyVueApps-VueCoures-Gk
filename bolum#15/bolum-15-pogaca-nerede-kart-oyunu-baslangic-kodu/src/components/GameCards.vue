...
/************* ==> Açık Kartların Animasyonları İçin Gerekli Olan Transaction Class Tanimlari <== ********************/
.rotate-all-enter {
}
...
/************* ==> Kapalı Kartların Animasyonları İçin Gerekli Olan Transaction Class Tanimlari <== ********************/
.rotate-enter-active {
